...
class FbkDartStringView extends StatefulWidget {
  ...
  bool? exercise1() {
    ...
    if (productName != productName.contains(query)) {
      isValid = true;
    }
    return isValid;
  }
  ...
  bool? exercise4() {
    bool isValid = false;
    int number = 23;
    String code = number.toString().padLeft(4, "0");
  ...
  bool? exercise5() {
    bool isValid = false;
    int number = 27;
    String code = number.toString().padRight(5, "0");
  ...
  bool exercise18() {
    ...
    double? output;
    // String textDelete = input.replaceAll(RegExp(r'[^\d.]'), '');
    // output = double.parse(textDelete);
